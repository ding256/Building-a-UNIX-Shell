...
{
       0,    77,    77,    81,    82,    86,    95,    98,   102,   106,
     114,   114,   128,   142,   146,   147,   151,   154,   158,   165,
     171,   180,   188,   194,   203,   204
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "NOTOKEN", "NEWLINE", "PIPE",
  "GREAT", "LESS", "GREATAMPERSAND", "GREATGREAT", "GREATGREATAMPERSAND",
  "AMPERSAND", "TWOGREAT", "EXIT", "AMBIGUOUS", "$accept", "goal",
  "command_list", "command_line", "cmd_and_args", "$@1", "arg_list",
  "pipe_list", "background_optional", "io_modifier", "io_modifier_list", YY_NULLPTR
};
#endif
...
{
       3,    -3,    -4,    -4,    -4,    -4,     7,     0,    -4,    -4,
       4,    -4,    -4,    -4,    -4,     6,    15,     8,    -4,     9,
      10,    13,    16,    26,    -4,    27,    28,    -4,    -4,    -4,
      -4,    -4,    -4,    -4,    -4,    -4
};
...
{
       0,     0,    10,     6,     8,     9,     0,     0,     3,    14,
      25,     7,    13,     1,     4,     0,    17,    11,    15,     0,
       0,     0,     0,     0,    16,     0,     0,    24,    12,    19,
      22,    21,    18,    20,    23,     5
};
...
{
      -2,     1,    11,     2,     1,     3,     2,    13,     3,     2,
      15,    28,    29,    30,     4,     5,    31,     4,     5,    32,
       4,     5,    19,    20,    21,    22,    23,    24,    25,    33,
      34,    14,    18,    35
};
...
{
       0,     1,     5,     3,     1,     5,     3,     0,     5,     3,
       6,     3,     3,     3,    14,    15,     3,    14,    15,     3,
      14,    15,     7,     8,     9,    10,    11,    12,    13,     3,
       3,     7,    15,     5
};
...
{
       0,     1,     3,     5,    14,    15,    17,    18,    19,    20,
      23,     5,    21,     0,    19,     6,    26,    22,    20,     7,
       8,     9,    10,    11,    12,    13,    24,    25,     3,     3,
       3,     3,     3,     3,     3,     5
};
...
#line 128 "shell.y"
    ...
    wildCard = false;
    char *p = (char *)"";
    expand(p, (char *)((yyvsp[0].cpp_string)->c_str()));
